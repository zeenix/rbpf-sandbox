...
fn main() {
    ...
    let mut sed_process = match Command::new("sed")
                     .arg("-e s/6112 5000 0000/7912 5000 0000/")
                     .arg("-e s/6112 4c00 0000/7912 4000 0000/")
                     .arg("-e s/6112 2200 0000/7912 2200 0000/")
                     .arg("-e s/6111 5000 0000/7911 5000 0000/")
                     .arg("-e s/6111 4c00 0000/7911 4000 0000/")
                     .arg("-e s/6111 2200 0000/7911 2200 0000/")
                     .stdin(Stdio::piped())
                     .stdout(Stdio::piped())
                     .spawn() {
